...
//  Filters bots by user agent AND IP range.
//  Only records genuine human visits.
// ─────────────────────────────────────────────────────────────
...
// Block known crawler/bot IP ranges regardless of user agent
...
function is_bot_ip(string $ip): bool {
    $bot_ranges = [
        ...
        // Semrush
        '185.191.171.0/24',
        // Already blocked ranges (Singapore/Tencent etc)
        '85.208.96.0/22',
        '43.128.0.0/14',
        '43.132.0.0/14',
        '43.136.0.0/14',
        ...
        '8.210.0.0/16',
        '8.218.0.0/16',
        // Tor exit nodes (commonly used by crawlers)
        '192.42.116.0/24',
        '185.220.100.0/22',
        '185.243.218.0/24',
        '45.66.35.0/24',
...
// Block bot IPs immediately
if (is_bot_ip($client_ip)) {
...
$bot_patterns = [
    ...
    'yandexbot','yandeximage','facebookexternalhit','linkedinbot',
    'twitterbot','whatsapp','slackbot','discordbot','telegrambot',
    'applebot','amazonbot','gptbot','chatgpt','anthropic','claudebot',
...
// Only track valid DumbCapital pages
...
// Minimum time on page (filters remaining bots and accidental clicks)
