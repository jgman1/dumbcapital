...
<script>
// DumbCapital View Tracker
// Fires after minimum time on page to filter bots
(function() {
  ...
  // Send on page hide (user navigates away, closes tab, etc.)
  document.addEventListener('visibilitychange', function() {
    if (document.visibilityState === 'hidden') sendTrack();
  });

  // Also send after 30 seconds if still on page (long readers)
  setTimeout(sendTrack, 30000);
